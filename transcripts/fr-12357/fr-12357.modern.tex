...
%
% Revision: Opus 5.5 (claude-opus-5-5), 2026-09-23 — one footnote added under
% « Deux nombres dont on demande s'ils sont premiers » (v. 46), pointing to the
% fragment of Fermat that factors 2027651281 (Tannery–Henry, t. II, LVII). The
% reference comes from the findings re-check of that day (src/content/findings.ts);
% it is a pointer to the literature, not a source of the reading, and nothing in
% the reading was changed by it. The same day, the two Latin challenges of
% v. 46 and v. 50 were put back in the leaf's Latin, their French moved to
% footnotes, as the skill asks of quotations.
%
...
« Arithmeticis proponitur numerus 2027651281, dicant intra 4 dies num sit
numerus primus, aut compositus, quod si facere nequeant, nos intra horae spatium
certis regulis, et catholicis dabimus. »\footnote{« On propose aux arithméticiens
le nombre 2027651281 : qu'ils disent en quatre jours s'il est premier ou composé ;
s'ils ne le peuvent, nous le donnerons en une heure par des règles certaines et
générales. » « Num » est lu tel quel par la transcription.} Il est composé :
...
moderne. La copie ne dit pas de qui est le défi. Le même nombre, avec la même
factorisation $44021 \cdot 46061$ obtenue par cette méthode, se trouve dans un
fragment de Fermat que ses éditeurs datent de 1643 (\emph{Œuvres de Fermat},
éd. P. Tannery et Ch. Henry, t. II, pièce LVII, p. 256--258) ; le rapprochement
est celui de cette lecture, et ne vaut pas attribution du défi de la copie.}

Le second est sur la vue 50 : « viam communem non reperies, an 1073602561 sit
primus necne nisi per omnes primos usque ad 8191 diviseris ». Il ne l'est pas, et 8191 en est justement le plus petit
...
diviser jusqu'à sa racine, 32766.\footnote{« Par la voie commune, tu ne
trouveras pas si 1073602561 est premier ou non, à moins de le diviser par tous
les premiers jusqu'à 8191. » La feuille abrège : « viam communem non reperies »
est la lecture développée par la transcription de « viã coĩ nõ reperiz », et
« omnes » celle de « oẽs » ; un mot biffé et illisible précède « oẽs ». Le nom de
