...
export const FINDINGS: Finding[] = [
  ...
  },
  {
    ...
    literature: [
      ...
      "Not searched: Mersenne's Correspondance ed. de Waard, which gives the manuscript source of each letter and would say how much of the Torricelli\u2013Roberval exchange is in Latin 11196 and what Latin 11197 holds.",
    ],
    status: 'candidate',
    settle:
      'Read Latin 11196 and 11197 in the reading room, or the manuscript notes in Mersenne\u2019s Correspondance. That would give the contents of the two undigitised volumes and show whether Flayder\u2019s opusculum and the Huygens letters of the group title are there. What is already settled is that they are not in Latin 11195.',
  },
];
